...
public class TurmaController {
    ...
    @ApiOperation(value="Listar todos as turmas  existentes.",response= Aluno.class, nickname = "findAll",
            notes="Essa operação retorna lista com as informações de todas as turmas.")
    @ApiResponses(value= {
            @ApiResponse(code=200, message="Retorna lista de Turmas.", response=Aluno.class),
    ...
    @ApiOperation(
            value="Listar informações de uma turma.", response=Aluno.class,
            notes="Essa operação retorna informações de uma turma.")
    @ApiResponses(value= {
            @ApiResponse(code=200,message="Retorna os dados de uma turma.",response=Aluno.class),
    ...
    @ApiOperation(value="Inserir uma nova turma  na base de dados.",response=Aluno.class,
            notes="Essa operação grava uma nova turma.")
    @ApiResponses(value= {
            @ApiResponse(code=200, message="Retorna a turma cadastrada.", response=Aluno.class),
            @ApiResponse(code=500, message="Erro interno do servidor.", response=Aluno.class),
            @ApiResponse(code=400, message="Problemas com a Requisição.", response=Aluno.class)})
    ...
    @ApiOperation(value="Atualizar informações de uma turma  base de dados.",response=Aluno.class,
            notes="Essa operação atualiza dados de uma turma.")
    @ApiResponses(value= {
            @ApiResponse(code=200, message="Retorna a turma  com informações atualizadas.", response=Aluno.class),
            @ApiResponse(code=404,message="Erro apresentado quando não encontra o ID informado.",response=Aluno.class),
            @ApiResponse(code=500, message="Erro interno do servidor.", response=Aluno.class),
            @ApiResponse(code=400, message="Problemas com a Requisição.", response=Aluno.class)})
    ...
    @ApiOperation(value="Exclusão de uma turma na base de dados.",response=Aluno.class,
            notes="Essa operação exclui PERMANENTEMENTE informações da turma  na base de dados.")
    @ApiResponses(value= {
            @ApiResponse(code=200, message="Turma Excluída.", response=Aluno.class),
            @ApiResponse(code=500, message="Erro interno do servidor.", response=Aluno.class),
            @ApiResponse(code=400, message="Problemas com a Requisição.", response=Aluno.class)})
    ...
    @ApiOperation(value="Listar de todas as turmas existentes na forma paginada.",response=Aluno.class,
